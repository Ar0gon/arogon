...
function usage()
{
    ...
    echo "and generates the checksum files of the Arogon tag provided."
    echo
...
# -- Config
GITHUB_REPO="https://github.com/Arogon/Arogon.git"
CLONE_DIR="$BUILD_DIRECTORY/Arogon-buildall"
TARGET_DIR="$BUILD_DIRECTORY/Arogon-releases"
DYNAMIC_RELEASE="Arogon-${TAG_VERSION}-linux-CLI"
STATIC_RELEASE="Arogon-${TAG_VERSION}-linux-staticboost-CLI"
